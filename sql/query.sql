...
(order_id, date, item_name, item_type, item_price, quantity, 
 ...
 month, year, month_year, day_name, quarter);
...
-- Peak Day: Hari dengan total penjualan tertinggi
SELECT 
    day_name,
    COUNT(order_id) AS total_transactions,
    SUM(transaction_amount) AS total_sales
...
(
    SELECT 'order_id','date','item_name','item_type','item_price','quantity',
           'transaction_amount','transaction_type','received_by','time_of_sale',
           'month','year','month_year','day_name','quarter'
)
UNION ALL
...
INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/hasil_foodsales.csv'
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n';
